...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Yes, we understand that legal services can be a significant investment. We offer flexible payment plans tailored to your financial situation. For certain types of cases, we may work on a contingency fee basis, meaning we only get paid if we win your case. We accept all major Nepali banks' debit/credit cards and can discuss other financing options during your consultation. Our goal is to make quality legal representation accessible while being transparent about costs.",
  },
]
