...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const WEB3FORMS_API_KEY = "3a679fe2-f64a-48fe-93dc-3c20dab28248"
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Bhaktapur</p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">+977 980000000</p>
                    <p className="text-muted-foreground">Toll Free: 0800 0000</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">info@justicelawfirm.com</p>
                    <p className="text-muted-foreground">support@justicelawfirm.com</p>
                  </div>
                </div>
 ...
 <div className="h-[300px] w-full overflow-hidden rounded-lg border border-border">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3531.239967502278!2d85.4221618744486!3d27.671843076201234!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb1a7a4b1f6d7b%3A0x3d0df7e34e8b4b89!2sBhaktapur!5e0!3m2!1sen!2snp!4v1730315750825!5m2!1sen!2snp"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
